...
<div class="layout">
    ...
    <div class="colors" id="colors">
        ...
        <button style="background-color: rgb(79, 70, 156);  "
                onclick="changeColor('بنفسجي')">بنفسجي</button>
        ...
        <button style="background-color: #335b54;"
                onclick="changeColor('اخضر غامق')">اخضر غامق</button>

        <button style="background-color: #1b2225;"
                onclick="changeColor('اسود')">اسود</button>
