...
@section('title')
    <title>تعديل {{ $role->name }}</title>
@endsection

@section('nav_title')
    <x-layout.back back="admin/roles" title="الصلاحيات"></x-layout.back>
@endsection
...
@section('content')
    <div class="content">
        ...
        <div class="actions border-0" >
            <x-layout.back  back="admin/roles" title=" تعديل {{ $role->name }}"></x-layout.back>
        </div>
        ...
        <form class="row form_style" action="/admin/roles/{{ $role->id }}" method="post">
            ...
            <div class="col-12">
                ...
                <x-form.input col="col-12" value="{{ $role->name }}" required label="اسم الصلاحية" name="name"
            ...
            <div class="col-12 mt-3">
                <x-form.button title="تعديل" id="submitBtn"></x-form.button>
            </div>
        </form>
    </div>
@endsection
