...
<link rel="stylesheet" href="{{ asset('assets/admin/css/adminstyle.css?ver=1.2') }}">
<link rel="stylesheet" href="{{ asset('assets/admin/css/mobile.css?ver=1.1') }}" media="screen and (max-width: 992px)">




 <link rel="shortcut icon" href="{{get_logo()}}" type="image/x-icon">
