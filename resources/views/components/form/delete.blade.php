    ...
    <div class="modal-dialog">
        <form class="modal-content" method="post" action="/{{$path}}">
            ...
            <div class="modal-body" style="padding: 15px">
                سيتمّ حذف : <strong style="font-size: 14px" id="delete_title"></strong>
                ...
                <div class="d-flex align-items-center my-3">
                    <input style="margin-left:10px" type="checkbox" name="confirm" id="confirmCheckBox">
                    <label for="confirmCheckBox">تأكيد حذف {{$title}}</label>
                </div>
            </div>
            <div class="modal-footer">
                <x-form.button class="delete" id="deleteBtn" disabled title="تأكيد الحذف"></x-form.button>
